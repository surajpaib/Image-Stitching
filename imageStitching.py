...
def main(args):
    ...
    harris_kd = KeypointDetector(block_size=args.harris_neighbourhood_size, descriptor_method='sift', keypoint_threshold=0.01)
    ...
    matched_image = cv2.drawMatchesKnn(first_image,kp1,second_image,kp2,good, None, flags=2)
