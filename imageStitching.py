...
def main(args):
    ...
    harris_kd = KeypointDetector(block_size=args.harris_neighbourhood_size, descriptor_method='sift', keypoint_threshold=0.1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_matches", help="Number of pixels in the harris neighbourhood", type=int, default=10)
